  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div
            className="w-full h-screen sm:h-auto sm:w-3/4 md:w-3/5 lg:w-[1000px] xl:w-[1100px] sm:rounded-2xl bg-customDarkBgTransparentLighter custom-border-gray-darker py-4 px-8 sm:px-16 backdrop-blur-xl sm:mb-8 fixed mx-auto z-50"
